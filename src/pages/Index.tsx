  ...
  const handleProfessionalTemplate = (template: any) => {
    const quickData = {
      ...
      dynamicFields: {
        ...
        scopeOfWork: `Professional ${template.title.toLowerCase()} with comprehensive terms and conditions`,
        deliverables: 'As specified in the agreement terms',
        jurisdiction: 'State of California, USA',
        terminationConditions: 'Either party may terminate with proper notice as specified'
      },
      language: 'en',
      footerText: 'Generated by GenContract - Professional Contract Solutions'
    };
    
    handleContractGenerate(quickData);
  };
